    ...
    <div class="hero-copy mx-auto px-5 pb-12 sm:px-10 sm:pb-16 lg:px-16 xl:px-20">
        <div class="max-w-[780px]">
            ...
            <p class="hero-reveal mt-8 max-w-[570px] text-justify text-[14px] leading-[1.5] text-meem-deep sm:text-[16px] sm:leading-[1.5]" style="--reveal-delay: 160ms">
                An integrated real estate investment and property <br> management company delivering long-term value, <br> resilient portfolios, and operational excellence.
            </p>
        </div>
    </div>
</section>
...
<section id="about" class="grid bg-[linear-gradient(90deg,rgba(247,243,236,0.18)_0%,rgba(247,243,236,0.68)_45%,rgba(247,243,236,0.96)_100%),url('/assets/who_we_are_bg.webp')] bg-cover bg-center max-[639px]:bg-[linear-gradient(180deg,rgba(247,243,236,0.18)_0%,rgba(247,243,236,0.78)_48%,rgba(247,243,236,0.98)_100%),url('/assets/who_we_are_bg.webp')] max-[639px]:bg-top lg:min-h-[720px] lg:grid-cols-2">
    ...
    <div class="flex items-center justify-start px-5 py-10 max-[639px]:items-end sm:px-12 sm:py-20 lg:min-h-[720px] lg:px-16 xl:px-[8vw]">
        <div class="max-w-[600px]">
            ...
            <div class="reveal-up mt-9 space-y-3 xl:space-y-7 text-justify text-[14px] leading-[1.5] text-meem-deep sm:text-[15px] sm:leading-[1.5]" data-reveal style="--reveal-delay: 120ms">
                <p>
                    MEEM Real Estate Investment LLC is a UAE-based company focused on acquiring, developing, and managing diversified real estate assets across residential, commercial, hospitality, and retail sectors.
                </p>
                <p>
...
<section id="platform" class="bg-white px-5 py-10 sm:px-10 sm:py-16 lg:px-16 xl:px-20">
    <div class="mx-auto grid max-w-[1400px] gap-7 sm:grid-cols-2 lg:grid-cols-[1fr_1fr_.95fr] lg:gap-[90px]">
        <a class="feature-card reveal-up relative h-[430px] overflow-hidden sm:h-[480px]" data-reveal href="{{ route('expertise') }}" aria-label="Explore our expertise">
            <img class="absolute inset-0 h-full w-full object-cover object-[66%_center]" src="{{ asset('assets/home_platform.webp') }}" alt="">
            <span class="display-title absolute inset-0 z-10 flex items-end justify-center pb-7 text-[50px] text-white sm:pb-8">Expertise</span>
        </a>
